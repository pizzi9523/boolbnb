...
@section('content')
    <div class="container-fluid">
        ...
        <div class="table-responsive-lg">
            <table class="table table-striped table-light table-hover table-borderless table-sm">
                <thead>
                    <tr>
                        <th scope="col">Id</th>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($apartment->visibility === 1)
                                    <div class="visibility " style="color: green;">
                            ...
                            <td>
                                <a href="{{ route('guest.apartments.show', $apartment->slug) }}" class="btn btn_show"><i
                            ...
                            <td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade text-dark" id="delete{{ $apartment->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="modal_{{ $apartment->id }}" aria-hidden="true">
                            ...
                            <td>
                                <a href="{{ route('registered.statistics', $apartment->id) }}"
                                    class="btn text-white static"><i class="fa-solid fa-chart-line"></i>
                                    Statistiche
                                </a>
                            </td>
                        </tr>
